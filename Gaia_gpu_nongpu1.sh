...
if check_nvidia_gpu; then
    ...
    ~/gaianet/bin/gaianet init --config https://raw.githubusercontent.com/yinghao888/Gaia_Node/main/config1.json || { echo "❌ GaiaNet initialization failed!"; exit 1; }
else
    install_gaianet
    add_gaianet_to_path
...
~/gaianet/bin/gaianet config --domain gaias.gaia.domains
